...
extension UIView {
    func layerGradient() {
        ...
        let color0 = UIColor(hexString: "#DCDCDC")
        let color1 = UIColor(hexString: "#DCDCDC")
        let color2 = UIColor(hexString: "#FDFDFD")
...
extension UIImage {
    ...
    func splitImage() -> Array<UIImage> {
        ...
        for i in 1 ... 12 {
            ...
            imageArray.append(UIImage(cgImage: temp))
